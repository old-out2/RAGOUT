                    ...
                    children: [
                      ...
                      DropdownButton<String>(
                        ...
                        onChanged: (String? newValue) async {
                          ...
                          final pref = await SharedPreferences.getInstance();
                          pref.setInt(
                              'gender', sexList.lastIndexOf(dropdownSexValue));
                        },
                        items: sexList
              ...
              children: [
                ...
                Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(DateFormat('yyyy年MM月dd日').format(targetday)),
                        IconButton(
                          icon: Icon(
                    ...
                    children: [
                      ...
                      DropdownButton<String>(
                        ...
                        onChanged: (String? newValue) async {
                          ...
                          final pref = await SharedPreferences.getInstance();
                          pref.setInt('ActiveLevel',
                              exerciseList.lastIndexOf(dropdownzExerciseValue));
                        },
                        items: exerciseList
                            .map<DropdownMenuItem<String>>((String value) {
                          return DropdownMenuItem<String>(
